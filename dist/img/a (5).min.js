(function(){var h={},mt={},c={id:"4037cc2cae85a0650ac6293abc7fbe9e",dm:["mia.com"],js:"tongji.baidu.com/hm-web/js/",etrk:[],icon:'',ctrk:false,align:-1,nv:-1,vdur:1800000,age:31536000000,rec:0,rp:[],trust:0,vcard:0,qiao:0,lxb:0,kbtrk:0,pt:0,conv:0,med:0,cvcc:'',cvcf:[],apps:''};var q=void 0,r=!0,t=null,u=!1;mt.cookie={};mt.cookie.set=function(a,b,d){var f;d.I&&(f=new Date,f.setTime(f.getTime()+d.I));document.cookie=a+"="+b+(d.domain?"; domain="+d.domain:"")+(d.path?"; path="+d.path:"")+(f?"; expires="+f.toGMTString():"")+(d.lb?"; secure":"")};mt.cookie.get=function(a){return(a=RegExp("(^| )"+a+"=([^;]*)(;|$)").exec(document.cookie))?a[2]:t};mt.h={};mt.h.pa=function(a){return document.getElementById(a)};
...
mt.h.cb=function(a){return(a=mt.h.L(a,r))&&a.length?String(a[0]):""};mt.h.bb=function(a){return mt.h.L(a,u)};mt.h.$a=function(a,b){for(b=b.toUpperCase();(a=a.parentNode)&&1==a.nodeType;)if(a.tagName==b)return a;return t};mt.h.qa=function(a){return 9===a.nodeType?a:a.ownerDocument||a.document};
mt.h.ab=function(a){var b={top:0,left:0};if(!a)return b;var d=mt.h.qa(a).documentElement;"undefined"!==typeof a.getBoundingClientRect&&(b=a.getBoundingClientRect());return{top:b.top+(window.pageYOffset||d.scrollTop)-(d.clientTop||0),left:b.left+(window.pageXOffset||d.scrollLeft)-(d.clientLeft||0)}};
(mt.h.Ha=function(){function a(){if(!a.B){a.B=r;for(var b=0,d=f.length;b<d;b++)f[b]()}}function b(){try{document.documentElement.doScroll("left")}catch(d){setTimeout(b,1);return}a()}var d=u,f=[],g;document.addEventListener?g=function(){document.removeEventListener("DOMContentLoaded",g,u);a()}:document.attachEvent&&(g=function(){"complete"===document.readyState&&(document.detachEvent("onreadystatechange",g),a())});(function(){if(!d)if(d=r,"complete"===document.readyState)a.B=r;else if(document.addEventListener)document.addEventListener("DOMContentLoaded",
...
(function(){var a=mt.event;mt.f={};mt.f.Ea=/msie (\d+\.\d+)/i.test(navigator.userAgent);mt.f.Ca=/msie (\d+\.\d+)/i.test(navigator.userAgent)?document.documentMode||+RegExp.$1:q;mt.f.cookieEnabled=navigator.cookieEnabled;mt.f.javaEnabled=navigator.javaEnabled();mt.f.language=navigator.language||navigator.browserLanguage||navigator.systemLanguage||navigator.userLanguage||"";mt.f.Ja=(window.screen.width||0)+"x"+(window.screen.height||0);mt.f.colorDepth=window.screen.colorDepth||0;mt.f.M=function(){var a;
...
d[n],typeof e){case "undefined":case "unknown":case "function":break;default:g&&l.push(","),g=1,l.push(p(n)+":"+p(e))}l.push("}");return l.join("")}}}();mt.lang={};mt.lang.d=function(a,b){return"[object "+b+"]"==={}.toString.call(a)};mt.lang.Fa=function(){var a=h.b.a.kb;return mt.lang.d(a,"Number")&&isFinite(a)};mt.lang.hb=function(a){return mt.lang.d(a,"String")};mt.lang.k=function(a){return a.replace?a.replace(/'/g,"'0").replace(/\*/g,"'1").replace(/!/g,"'2"):a};mt.localStorage={};
...
mt.sessionStorage.get=function(a){return window.sessionStorage?window.sessionStorage.getItem(a):t};mt.sessionStorage.remove=function(a){window.sessionStorage&&window.sessionStorage.removeItem(a)};mt.ba={};mt.ba.log=function(a,b){var d=new Image,f="mini_tangram_log_"+Math.floor(2147483648*Math.random()).toString(36);window[f]=d;d.onload=d.onerror=d.onabort=function(){d.onload=d.onerror=d.onabort=t;d=window[f]=t;b&&b(a)};d.src=a};mt.U={};
mt.U.va=function(){var a="";if(navigator.plugins&&navigator.mimeTypes.length){var b=navigator.plugins["Shockwave Flash"];b&&b.description&&(a=b.description.replace(/^.*\s+(\S+)\s+\S+$/,"$1"))}else if(window.ActiveXObject)try{if(b=new ActiveXObject("ShockwaveFlash.ShockwaveFlash"))(a=b.GetVariable("$version"))&&(a=a.replace(/^.*\s+(\d+),(\d+).*$/,"$1.$2"))}catch(d){}return a};
...
mt.url.i=function(a,b){var d=a.match(RegExp("(^|&|\\?|#)("+b+")=([^&#]*)(&|$|#)",""));return d?d[3]:t};mt.url.eb=function(a){return(a=a.match(/^(https?:)\/\//))?a[1]:t};mt.url.sa=function(a){return(a=a.match(/^(https?:\/\/)?([^\/\?#]*)/))?a[2].replace(/.*@/,""):t};mt.url.K=function(a){return(a=mt.url.sa(a))?a.replace(/:\d+$/,""):a};mt.url.L=function(a){return(a=a.match(/^(https?:\/\/)?[^\/]*(.*)/))?a[2].replace(/[\?#].*/,"").replace(/^$/,"/"):t};
(function(){function a(){for(var a=u,d=document.getElementsByTagName("script"),f=d.length,f=100<f?100:f,g=0;g<f;g++){var n=d[g].src;if(n&&0===n.indexOf("https://hm.baidu.com/h")){a=r;break}}return a}return h.oa=a})();var A=h.oa;
h.s={fb:"http://tongji.baidu.com/hm-web/welcome/ico",aa:"hm.baidu.com/hm.gif",fa:"tongji.baidu.com",za:"hmmd",Aa:"hmpl",Sa:"utm_medium",ya:"hmkw",Ua:"utm_term",wa:"hmci",Ra:"utm_content",Ba:"hmsr",Ta:"utm_source",xa:"hmcu",Qa:"utm_campaign",r:0,m:Math.round(+new Date/1E3),F:Math.round(+new Date/1E3)%65535,protocol:"https:"===document.location.protocol?"https:":"http:",Q:A()||"https:"===document.location.protocol?"https:":"http:",gb:0,Wa:6E5,Ga:6E5,jb:5E3,Xa:5,Ya:1024,Va:1,R:2147483647,ca:"kb cc cf ci ck cl cm cp cu cw ds vl ep et fl ja ln lo lt rnd si su v cv lv api sn ct u tt".split(" ")};
...
g.c(window,"blur",f))})();h.G={ta:function(){return+new Date-w},ra:function(){return y?+new Date-m+s:s}};n.c("pv-b",function(){g.c(window,"unload",a())});return h.G})();
(function(){var a=mt.lang,b=h.s,d=h.load,f={Da:function(g){if((window._dxt===q||a.d(window._dxt,"Array"))&&"undefined"!==typeof h.b){var f=h.b.J();d([b.protocol,"//datax.baidu.com/x.js?si=",c.id,"&dm=",encodeURIComponent(f)].join(""),g)}},Pa:function(d){if(a.d(d,"String")||a.d(d,"Number"))window._dxt=window._dxt||[],window._dxt.push(["_setUserId",d])}};return h.ia=f})();
(function(){function a(a,d,m,b){if(!(a===q||d===q||b===q)){if(""===a)return[d,m,b].join("*");a=String(a).split("!");for(var e,v=u,x=0;x<a.length;x++)if(e=a[x].split("*"),String(d)===e[0]){e[1]=m;e[2]=b;a[x]=e.join("*");v=r;break}v||a.push([d,m,b].join("*"));return a.join("!")}}function b(a){for(var e in a)if({}.hasOwnProperty.call(a,e)){var m=a[e];d.d(m,"Object")||d.d(m,"Array")?b(m):a[e]=String(m)}}var d=mt.lang,f=mt.l,g=mt.f,n=h.s,l=h.H,p=h.ia,e={w:[],C:0,Z:u,o:{V:"",page:""},init:function(){e.e=
0;l.c("pv-b",function(){e.ka();e.ma()});l.c("pv-d",function(){e.na();e.o.page=""});l.c("stag-b",function(){h.b.a.api=e.e||e.C?e.e+"_"+e.C:"";h.b.a.ct=[decodeURIComponent(h.b.getData("Hm_ct_"+c.id)||""),e.o.V,e.o.page].join("!")});l.c("stag-d",function(){h.b.a.api=0;e.e=0;e.C=0})},ka:function(){var a=window._hmt||[];if(!a||d.d(a,"Array"))window._hmt={id:c.id,cmd:{},push:function(){for(var a=window._hmt,k=0;k<arguments.length;k++){var b=arguments[k];d.d(b,"Array")&&(a.cmd[a.id].push(b),"_setAccount"===
b[0]&&(1<b.length&&/^[0-9a-f]{32}$/.test(b[1]))&&(b=b[1],a.id=b,a.cmd[b]=a.cmd[b]||[]))}}},window._hmt.cmd[c.id]=[],window._hmt.push.apply(window._hmt,a)},ma:function(){var a=window._hmt;if(a&&a.cmd&&a.cmd[c.id])for(var d=a.cmd[c.id],m=/^_track(Event|MobConv|Order|RTEvent)$/,b=0,f=d.length;b<f;b++){var v=d[b];m.test(v[0])?e.w.push(v):e.S(v)}a.cmd[c.id]={push:e.S}},na:function(){if(0<e.w.length)for(var a=0,d=e.w.length;a<d;a++)e.S(e.w[a]);e.w=t},S:function(a){var b=a[0];if(e.hasOwnProperty(b)&&d.d(e[b],
"Function"))e[b](a)},_setAccount:function(a){1<a.length&&/^[0-9a-f]{32}$/.test(a[1])&&(e.e|=1)},_setAutoPageview:function(a){if(1<a.length&&(a=a[1],u===a||r===a))e.e|=2,h.b.X=a},_trackPageview:function(a){if(1<a.length&&a[1].charAt&&"/"===a[1].charAt(0)){e.e|=4;h.b.a.et=0;h.b.a.ep="";h.b.a.vl=g.M()+g.N();h.b.a.kb=0;h.b.O?(h.b.a.nv=0,h.b.a.st=4):h.b.O=r;var b=h.b.a.u,d=h.b.a.su;h.b.a.u=n.protocol+"//"+document.location.host+a[1];e.Z||(h.b.a.su=document.location.href);h.b.j();h.b.a.u=b;h.b.a.su=d}},
...
c.age):h.b.Ia("Hm_cv_"+c.id)}}},_setUserTag:function(b){if(!(3>b.length)){var e=d.k(b[1]);b=d.k(b[2]);if(e!==q&&b!==q){var m=decodeURIComponent(h.b.getData("Hm_ct_"+c.id)||""),m=a(m,e,1,b);h.b.setData("Hm_ct_"+c.id,encodeURIComponent(m),c.age)}}},_setVisitTag:function(b){if(!(3>b.length)){var f=d.k(b[1]);b=d.k(b[2]);if(f!==q&&b!==q){var m=e.o.V,m=a(m,f,2,b);e.o.V=m}}},_setPageTag:function(b){if(!(3>b.length)){var f=d.k(b[1]);b=d.k(b[2]);if(f!==q&&b!==q){var m=e.o.page,m=a(m,f,3,b);e.o.page=m}}},_setReferrerOverride:function(a){1<
a.length&&(h.b.a.su=a[1].charAt&&"/"===a[1].charAt(0)?n.protocol+"//"+window.location.host+a[1]:a[1],e.Z=r)},_trackOrder:function(a){a=a[1];d.d(a,"Object")&&(b(a),e.e|=16,h.b.a.nv=0,h.b.a.st=4,h.b.a.et=94,h.b.a.ep=f.stringify(a),h.b.j())},_trackMobConv:function(a){if(a={webim:1,tel:2,map:3,sms:4,callback:5,share:6}[a[1]])e.e|=32,h.b.a.et=93,h.b.a.ep=a,h.b.j()},_trackRTPageview:function(a){a=a[1];d.d(a,"Object")&&(b(a),a=f.stringify(a),512>=encodeURIComponent(a).length&&(e.e|=64,h.b.a.rt=a))},_trackRTEvent:function(a){a=
a[1];if(d.d(a,"Object")){b(a);a=encodeURIComponent(f.stringify(a));var g=function(a){var b=h.b.a.rt;e.e|=128;h.b.a.et=90;h.b.a.rt=a;h.b.j();h.b.a.rt=b},m=a.length;if(900>=m)g.call(this,a);else for(var m=Math.ceil(m/900),s="block|"+Math.round(Math.random()*n.R).toString(16)+"|"+m+"|",l=[],v=0;v<m;v++)l.push(v),l.push(a.substring(900*v,900*v+900)),g.call(this,s+l.join("|")),l=[]}},_setUserId:function(a){a=a[1];p.Da();p.Pa(a)},_setAutoTracking:function(a){if(1<a.length&&(a=a[1],u===a||r===a))h.b.Y=a}};
e.init();h.ga=e;return h.ga})();
(function(){function a(){"undefined"===typeof window["_bdhm_loaded_"+c.id]&&(window["_bdhm_loaded_"+c.id]=r,this.a={},this.Y=this.X=r,this.O=u,this.init())}var b=mt.url,d=mt.ba,f=mt.U,g=mt.lang,n=mt.cookie,l=mt.f,p=mt.localStorage,e=mt.sessionStorage,k=h.s,w=h.H;a.prototype={P:function(a,b){a="."+a.replace(/:\d+/,"");b="."+b.replace(/:\d+/,"");var d=a.indexOf(b);return-1<d&&d+b.length===a.length},$:function(a,b){a=a.replace(/^https?:\/\//,"");return 0===a.indexOf(b)},A:function(a){for(var d=0;d<c.dm.length;d++)if(-1<
c.dm[d].indexOf("/")){if(this.$(a,c.dm[d]))return r}else{var e=b.K(a);if(e&&this.P(e,c.dm[d]))return r}return u},J:function(){for(var a=document.location.hostname,b=0,d=c.dm.length;b<d;b++)if(this.P(a,c.dm[b]))return c.dm[b].replace(/(:\d+)?[\/\?#].*/,"");return a},W:function(){for(var a=0,b=c.dm.length;a<b;a++){var d=c.dm[a];if(-1<d.indexOf("/")&&this.$(document.location.href,d))return d.replace(/^[^\/]+(\/.*)/,"$1")+"/"}return"/"},ua:function(){if(!document.referrer)return k.m-k.r>c.vdur?1:4;var a=
u;this.A(document.referrer)&&this.A(document.location.href)?a=r:(a=b.K(document.referrer),a=this.P(a||"",document.location.hostname));return a?k.m-k.r>c.vdur?1:4:3},getData:function(a){try{return n.get(a)||e.get(a)||p.get(a)}catch(b){}},setData:function(a,b,d){try{n.set(a,b,{domain:this.J(),path:this.W(),I:d}),d?p.set(a,b,d):e.set(a,b)}catch(f){}},Ia:function(a){try{n.set(a,"",{domain:this.J(),path:this.W(),I:-1}),e.remove(a),p.remove(a)}catch(b){}},Na:function(){var a,b,d,e,f;k.r=this.getData("Hm_lpvt_"+
...
k.F);break;case 90:this.a.rt&&a.push("rt="+this.a.rt)}return a.join("&")},Oa:function(){this.Na();this.a.si=c.id;this.a.su=document.referrer;this.a.ds=l.Ja;this.a.cl=l.colorDepth+"-bit";this.a.ln=String(l.language).toLowerCase();this.a.ja=l.javaEnabled?1:0;this.a.ck=l.cookieEnabled?1:0;this.a.lo="number"===typeof _bdhm_top?1:0;this.a.fl=f.va();this.a.v="1.2.36";this.a.cv=decodeURIComponent(this.getData("Hm_cv_"+c.id)||"");this.a.tt=document.title||"";this.a.vl=l.M()+l.N();var a=document.location.href;
this.a.cm=b.i(a,k.za)||"";this.a.cp=b.i(a,k.Aa)||b.i(a,k.Sa)||"";this.a.cw=b.i(a,k.ya)||b.i(a,k.Ua)||"";this.a.ci=b.i(a,k.wa)||b.i(a,k.Ra)||"";this.a.cf=b.i(a,k.Ba)||b.i(a,k.Ta)||"";this.a.cu=b.i(a,k.xa)||b.i(a,k.Qa)||""},init:function(){try{this.Oa(),0===this.a.nv?this.La():this.T(".*"),h.b=this,this.ha(),w.z("pv-b"),this.Ka()}catch(a){var b=[];b.push("si="+c.id);b.push("n="+encodeURIComponent(a.name));b.push("m="+encodeURIComponent(a.message));b.push("r="+encodeURIComponent(document.referrer));
d.log(k.Q+"//"+k.aa+"?"+b.join("&"))}},Ka:function(){function a(){w.z("pv-d")}this.X?(this.O=r,this.a.et=0,this.a.ep="",this.a.vl=l.M()+l.N(),this.j(a)):a();this.ib=+new Date},j:function(a){if(this.Y){var b=this;b.a.rnd=Math.round(Math.random()*k.R);w.z("stag-b");var e=k.Q+"//"+k.aa+"?"+b.Ma();w.z("stag-d");b.ea(e);d.log(e,function(d){b.T(d);g.d(a,"Function")&&a.call(b)})}},ha:function(){var a=document.location.hash.substring(1),d=RegExp(c.id),e=b.K(document.referrer)===k.fa?1:0,f=b.i(a,"jn"),g=/^heatlink$|^select$|^pageclick$/.test(f);
a&&(d.test(a)&&e&&g)&&(this.a.rnd=Math.round(Math.random()*k.R),a=document.createElement("script"),a.setAttribute("type","text/javascript"),a.setAttribute("charset","utf-8"),a.setAttribute("src",k.protocol+"//"+c.js+f+".js?"+this.a.rnd),f=document.getElementsByTagName("script")[0],f.parentNode.insertBefore(a,f))},ea:function(a){var b=e.get("Hm_unsent_"+c.id)||"",d=this.a.u?"":"&u="+encodeURIComponent(document.location.href),b=encodeURIComponent(a.replace(/^https?:\/\//,"")+d)+(b?","+b:"");e.set("Hm_unsent_"+
c.id,b)},T:function(a){var b=e.get("Hm_unsent_"+c.id)||"";b&&(a=encodeURIComponent(a.replace(/^https?:\/\//,"")),a=RegExp(a.replace(/([\*\(\)])/g,"\\$1")+"(%26u%3D[^,]*)?,?","g"),(b=b.replace(a,"").replace(/,$/,""))?e.set("Hm_unsent_"+c.id,b):e.remove("Hm_unsent_"+c.id))},La:function(){var a=this,b=e.get("Hm_unsent_"+c.id);if(b)for(var b=b.split(","),f=function(b){d.log(k.Q+"//"+decodeURIComponent(b),function(b){a.T(b)})},g=0,l=b.length;g<l;g++)f(b[g])}};return new a})();
(function(){var a=mt.event,b=mt.lang,d=h.s;if(c.kbtrk&&"undefined"!==typeof h.b){h.b.a.kb=b.Fa()?h.b.a.kb:0;var f=function(){h.b.a.et=85;h.b.a.ep=h.b.a.kb;h.b.j()};a.c(document,"keyup",function(){h.b.a.kb++});a.c(window,"unload",function(){f()});setInterval(f,d.Ga)}})();var B=h.s,C=h.load;c.pt&&C([B.protocol,"//ada.baidu.com/phone-tracker/insert_bdtj?sid=",c.pt].join(""));
...
s!==document&&k(d,y)!==u;)s=s.parentNode})}}})();(function(){var a=mt.h,b=mt.lang,d=mt.event,f=mt.l;if("undefined"!==typeof h.b&&b.d(c.cvcf,"Array")&&0<c.cvcf.length){var g={da:function(){for(var b=c.cvcf.length,f,p=0;p<b;p++)(f=a.pa(decodeURIComponent(c.cvcf[p])))&&d.c(f,"click",g.la())},la:function(){return function(){h.b.a.et=86;var a={n:"form",t:"clk"};a.id=this.id;h.b.a.ep=f.stringify(a);h.b.j()}}};a.Ha(function(){g.da()})}})();
